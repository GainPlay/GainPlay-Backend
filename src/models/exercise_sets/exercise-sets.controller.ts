...
export class ExerciseSetsController {
  ...
  @ApiResponse({
    status: 201,
    type: ExerciseSetDto,
    description: "The exercise set has been created",
  })
  ...
  @Post("batch")
  @ApiOperation({
    summary: "Create multiple exercise sets for a workout exercise",
  })
  @ApiResponse({
    status: 201,
    type: [ExerciseSetDto],
    description: "The exercise sets have been created",
  })
  @ApiQuery({
    type: Number,
  ...
  @ApiQuery({
    type: Number,
    name: "count",
    description: "Number of sets to create",
  })
  @ApiQuery({
    name: "reps",
    type: Number,
    description: "Number of reps for each set",
  })
  createMany(
  ...
  @ApiResponse({
    status: 200,
    type: [ExerciseSetDto],
    description: "Return all exercise sets",
  })
  findAll() {
  ...
  @ApiResponse({
    status: 200,
    type: [ExerciseSetDto],
    description: "Return exercise sets for the workout exercise",
  })
  ...
  @ApiResponse({
    status: 200,
    type: ExerciseSetDto,
    description: "Return the exercise set",
  })
  ...
  @ApiResponse({
    status: 200,
    type: ExerciseSetDto,
    description: "The exercise set has been updated",
  })
  @ApiResponse({ status: 404, description: "Exercise set not found" })
  @ApiParam({ name: "id", description: "Exercise Set ID" })
  update(
  ...
  @ApiResponse({
    status: 200,
    type: ExerciseSetDto,
    description: "The exercise set has been marked as completed",
  })
  @ApiResponse({ status: 404, description: "Exercise set not found" })
  @ApiParam({ name: "id", description: "Exercise Set ID" })
  ...
  @ApiResponse({
    status: 204,
    description: "The exercise set has been deleted",
  })
  @ApiResponse({ status: 404, description: "Exercise set not found" })
  @ApiParam({ name: "id", description: "Exercise Set ID" })
