...
async function main() {
  ...
  await prisma.exercise_sets.createMany({
    data: [
      // John's first workout
      { reps: 12, set_number: 1, completed_reps: 3, workout_exercise_id: 1 },
      { reps: 12, set_number: 2, completed_reps: 3, workout_exercise_id: 1 },
      { reps: 12, set_number: 3, completed_reps: 3, workout_exercise_id: 1 },
      { reps: 15, set_number: 1, completed_reps: 3, workout_exercise_id: 2 },
      { reps: 15, set_number: 2, completed_reps: 3, workout_exercise_id: 2 },
      { reps: 15, set_number: 3, completed_reps: 3, workout_exercise_id: 2 },
      { reps: 15, set_number: 4, completed_reps: 3, workout_exercise_id: 2 },
      { reps: 34, set_number: 1, completed_reps: 4, workout_exercise_id: 3 },
      { reps: 34, set_number: 2, completed_reps: 4, workout_exercise_id: 3 },
      { reps: 35, set_number: 3, completed_reps: 5, workout_exercise_id: 3 },

      // John's second workout
      { reps: 3, set_number: 1, completed_reps: 2, workout_exercise_id: 4 },
      { reps: 11, set_number: 1, completed_reps: 1, workout_exercise_id: 5 },
      { reps: 11, set_number: 2, completed_reps: 1, workout_exercise_id: 5 },
      { reps: 13, set_number: 3, completed_reps: 3, workout_exercise_id: 5 },

      // John's in-progress workout
      { reps: 3, set_number: 1, completed_reps: 3, workout_exercise_id: 6 },
      { reps: 3, set_number: 2, completed_reps: 7, workout_exercise_id: 6 },
      { reps: 7, set_number: 3, completed_reps: 7, workout_exercise_id: 6 },
      { reps: 7, set_number: 4, completed_reps: 7, workout_exercise_id: 6 },
      { reps: 11, set_number: 5, completed_reps: 11, workout_exercise_id: 6 },
      { reps: 2, set_number: 1, completed_reps: 2, workout_exercise_id: 7 },
      { reps: 2, set_number: 2, completed_reps: 2, workout_exercise_id: 7 },
      { reps: 2, set_number: 3, completed_reps: 2, workout_exercise_id: 7 },

      // Jane's first workout (partial)
      { reps: 5, set_number: 1, completed_reps: 2, workout_exercise_id: 8 },
      { reps: 5, set_number: 2, completed_reps: 2, workout_exercise_id: 8 },
      { reps: 5, set_number: 3, completed_reps: 2, workout_exercise_id: 8 },
      { reps: 5, set_number: 4, completed_reps: 2, workout_exercise_id: 8 },
      { reps: 5, set_number: 5, completed_reps: 2, workout_exercise_id: 8 },
      { reps: 5, set_number: 1, completed_reps: 2, workout_exercise_id: 9 },
      { reps: 5, set_number: 2, completed_reps: 2, workout_exercise_id: 9 },
      { reps: 5, set_number: 3, completed_reps: 2, workout_exercise_id: 9 },

      // Mike's workout (partial)
      { reps: 12, set_number: 1, completed_reps: 2, workout_exercise_id: 18 },
      { reps: 12, set_number: 2, completed_reps: 2, workout_exercise_id: 18 },
      { reps: 12, set_number: 3, completed_reps: 2, workout_exercise_id: 18 },

      // David's workout
      { reps: 12, set_number: 1, completed_reps: 2, workout_exercise_id: 27 },
      { reps: 12, set_number: 2, completed_reps: 2, workout_exercise_id: 27 },
      { reps: 12, set_number: 3, completed_reps: 2, workout_exercise_id: 27 },
    ],
  });
