...
async function main() {
  ...
  await prisma.exercises.createMany({
    data: [
      { name: 'Push Up', description: 'Standard push-up exercise', category: 'Bodyweight', difficulty_level: 2, muscle_group: 'Chest' },
      { name: 'Pull Up', description: 'Upper body compound pulling exercise', category: 'Bodyweight', difficulty_level: 3, muscle_group: 'Back' },
      { name: 'Squat', description: 'Lower body compound exercise', category: 'Bodyweight', difficulty_level: 2, muscle_group: 'Legs' },
      { name: 'Bench Press', description: 'Upper body pressing exercise with barbell', category: 'Strength', difficulty_level: 3, muscle_group: 'Chest' },
      { name: 'Deadlift', description: 'Full body pulling exercise with barbell', category: 'Strength', difficulty_level: 4, muscle_group: 'Back' },
      { name: 'Bicep Curl', description: 'Isolation exercise for biceps', category: 'Strength', difficulty_level: 2, muscle_group: 'Arms' },
      { name: 'Plank', description: 'Core stabilizing exercise', category: 'Bodyweight', difficulty_level: 2, muscle_group: 'Core' },
      { name: 'Running', description: 'Cardiovascular exercise', category: 'Cardio', difficulty_level: 2, muscle_group: 'Full Body' },
      { name: 'Lunges', description: 'Unilateral lower body exercise', category: 'Bodyweight', difficulty_level: 2, muscle_group: 'Legs' },
      { name: 'Shoulder Press', description: 'Upper body pressing exercise with dumbbells', category: 'Strength', difficulty_level: 3, muscle_group: 'Shoulders' }
    ]
  });
  ...
  await prisma.workouts.createMany({
    data: [
      { user_id: 1, started_at: new Date('2025-04-20 08:30:00'), completed_at: new Date('2025-04-20 09:15:00'), coins_earned: 50 },
      { user_id: 1, started_at: new Date('2025-04-22 07:45:00'), completed_at: new Date('2025-04-22 08:30:00'), coins_earned: 45 },
      { user_id: 1, started_at: new Date('2025-04-25 18:00:00'), completed_at: null, coins_earned: null },
      { user_id: 2, started_at: new Date('2025-04-15 19:00:00'), completed_at: new Date('2025-04-15 20:30:00'), coins_earned: 75 },
      { user_id: 2, started_at: new Date('2025-04-18 18:30:00'), completed_at: new Date('2025-04-18 19:45:00'), coins_earned: 60 },
      { user_id: 2, started_at: new Date('2025-04-21 06:00:00'), completed_at: new Date('2025-04-21 07:15:00'), coins_earned: 80 },
      { user_id: 2, started_at: new Date('2025-04-24 17:30:00'), completed_at: new Date('2025-04-24 19:00:00'), coins_earned: 70 },
      { user_id: 3, started_at: new Date('2025-04-19 12:00:00'), completed_at: new Date('2025-04-19 12:45:00'), coins_earned: 30 },
      { user_id: 4, started_at: new Date('2025-04-16 05:30:00'), completed_at: new Date('2025-04-16 06:30:00'), coins_earned: 55 },
      { user_id: 4, started_at: new Date('2025-04-19 06:00:00'), completed_at: new Date('2025-04-19 07:00:00'), coins_earned: 60 },
      { user_id: 4, started_at: new Date('2025-04-22 05:45:00'), completed_at: new Date('2025-04-22 06:45:00'), coins_earned: 65 },
      { user_id: 4, started_at: new Date('2025-04-25 06:00:00'), completed_at: null, coins_earned: null },
      { user_id: 5, started_at: new Date('2025-04-23 20:00:00'), completed_at: new Date('2025-04-23 20:30:00'), coins_earned: 25 }
    ]
  });
  ...
  await prisma.exercise_sets.createMany({
    data: [
      // John's first workout
      { workout_exercise_id: 1, set_number: 1, reps: 12, completed: true, completed_at: new Date('2025-04-20 08:35:00') },
      { workout_exercise_id: 1, set_number: 2, reps: 12, completed: true, completed_at: new Date('2025-04-20 08:40:00') },
      { workout_exercise_id: 1, set_number: 3, reps: 12, completed: true, completed_at: new Date('2025-04-20 08:45:00') },
      { workout_exercise_id: 2, set_number: 1, reps: 15, completed: true, completed_at: new Date('2025-04-20 08:50:00') },
      { workout_exercise_id: 2, set_number: 2, reps: 15, completed: true, completed_at: new Date('2025-04-20 08:55:00') },
      { workout_exercise_id: 2, set_number: 3, reps: 15, completed: true, completed_at: new Date('2025-04-20 09:00:00') },
      { workout_exercise_id: 2, set_number: 4, reps: 15, completed: true, completed_at: new Date('2025-04-20 09:05:00') },
      { workout_exercise_id: 3, set_number: 1, reps: 30, completed: true, completed_at: new Date('2025-04-20 09:10:00') },
      { workout_exercise_id: 3, set_number: 2, reps: 30, completed: true, completed_at: new Date('2025-04-20 09:12:00') },
      { workout_exercise_id: 3, set_number: 3, reps: 30, completed: true, completed_at: new Date('2025-04-20 09:15:00') },

      // John's second workout
      { workout_exercise_id: 4, set_number: 1, reps: 1, completed: true, completed_at: new Date('2025-04-22 08:15:00') },
      { workout_exercise_id: 5, set_number: 1, reps: 10, completed: true, completed_at: new Date('2025-04-22 08:20:00') },
      { workout_exercise_id: 5, set_number: 2, reps: 10, completed: true, completed_at: new Date('2025-04-22 08:25:00') },
      { workout_exercise_id: 5, set_number: 3, reps: 10, completed: true, completed_at: new Date('2025-04-22 08:30:00') },
      ...
      { workout_exercise_id: 8, set_number: 1, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:15:00') },
      { workout_exercise_id: 8, set_number: 2, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:20:00') },
      { workout_exercise_id: 8, set_number: 3, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:25:00') },
      { workout_exercise_id: 8, set_number: 4, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:30:00') },
      { workout_exercise_id: 8, set_number: 5, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:35:00') },
      { workout_exercise_id: 9, set_number: 1, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:45:00') },
      { workout_exercise_id: 9, set_number: 2, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:50:00') },
      { workout_exercise_id: 9, set_number: 3, reps: 5, completed: true, completed_at: new Date('2025-04-15 19:55:00') },

      // Mike's workout (partial)
      { workout_exercise_id: 18, set_number: 1, reps: 12, completed: true, completed_at: new Date('2025-04-19 12:15:00') },
      { workout_exercise_id: 18, set_number: 2, reps: 12, completed: true, completed_at: new Date('2025-04-19 12:20:00') },
      { workout_exercise_id: 18, set_number: 3, reps: 12, completed: true, completed_at: new Date('2025-04-19 12:25:00') },

      // David's workout
      { workout_exercise_id: 27, set_number: 1, reps: 12, completed: true, completed_at: new Date('2025-04-23 20:10:00') },
      { workout_exercise_id: 27, set_number: 2, reps: 12, completed: true, completed_at: new Date('2025-04-23 20:20:00') },
      { workout_exercise_id: 27, set_number: 3, reps: 12, completed: true, completed_at: new Date('2025-04-23 20:30:00') }
    ]
  });
